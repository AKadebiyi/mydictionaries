...
file_write.writerow(datastore["medical"][0].keys())

for i in range(len(datastore["medical"][0])):
    file_write.writerow(datastore["medical"][1].values())
"""
...
for each in list:
    ...
    newfile.write(str(rn) + "," + use + "," + str(sq) + "," + str(price) + "\n")
